...
const clockController = {
    ...
    delete: async(req,res) => {
        try {
            ...
            const deleteService = await ClockModel.findByIdAndDelete(clock._id.toString());
    ...
    update: async(req,res) => {
        try {
            ...
            const updateService = await ClockModel.findByIdAndUpdate(clock._id.toString(), req.body);
